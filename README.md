...
- Click RUN
- For tests: navigate to test folder, right-click files and click "Run `test_filename`"
...
## My Approach
- Took initial time to understand how to target the dog breed API responses, modeled the data layer to reflect the type of data that would come into the application.
- Separated the application into various layers to adhere to Clean Architecture Principles and MVVM, with a data layer, a di layer, a domain layer and presentation layer.
